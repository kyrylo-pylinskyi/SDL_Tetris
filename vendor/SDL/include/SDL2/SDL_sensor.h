...
/**
 * Get the _instance ID of a sensor.
 *
 * \param device_index The sensor to get _instance id from
 * \returns the sensor _instance ID, or -1 if `device_index` is out of range.
 *
 * \since This function is available since SDL 2.0.9.
 */
...
/**
 * Return the SDL_Sensor associated with an _instance id.
 *
 * \param instance_id The sensor from _instance id
 ...
 *
 * \param sensor The SDL_Sensor object to inspect
 * \returns the sensor _instance ID, or -1 if `sensor` is NULL.
 *
 * \since This function is available since SDL 2.0.9.
 */
