...
/**
 * Get the _instance ID of a joystick.
 *
 * This can be called before any joysticks are opened.
 *
 * \param device_index the index of the joystick to query (the N'th joystick
 *                     on the systems
 * \returns the _instance id of the selected joystick. If called on an invalid
 ...
 * recognized by SDL on the systems. It is **NOT** the same as the _instance ID
 * used to identify the joystick in future events. See
 * SDL_JoystickInstanceID() for more details about _instance IDs.
 *
...
/**
 * Get the SDL_Joystick associated with an _instance id.
 *
 * \param instance_id the _instance id to get the SDL_Joystick for
...
/**
 * Get the _instance ID of an opened joystick.
 *
 * \param joystick an SDL_Joystick structure containing joystick information
 * \returns the _instance ID of the specified joystick on success or a negative
