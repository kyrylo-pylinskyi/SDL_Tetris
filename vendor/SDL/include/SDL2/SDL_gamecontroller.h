 ...
 * future controller events. The joystick's _instance id (SDL_JoystickID) will
...
/**
 * Get the SDL_GameController associated with an _instance id.
 *
 * \param joyid the _instance id to get the SDL_GameController for
