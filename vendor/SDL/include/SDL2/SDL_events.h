...
typedef struct SDL_MouseMotionEvent
{
    ...
    Uint32 which;       /**< The mouse _instance id, or SDL_TOUCH_MOUSEID */
...
typedef struct SDL_JoyAxisEvent
{
    ...
    Uint32 timestamp;   /**< In milliseconds, populated using SDL_GetTicks() */
    SDL_JoystickID which; /**< The joystick _instance id */
...
typedef struct SDL_JoyDeviceEvent
{
    ...
    Uint32 timestamp;   /**< In milliseconds, populated using SDL_GetTicks() */
    Sint32 which;       /**< The joystick device index for the ADDED event, _instance id for the REMOVED event */
} SDL_JoyDeviceEvent;
...
typedef struct SDL_ControllerDeviceEvent
{
    ...
    Uint32 timestamp;   /**< In milliseconds, populated using SDL_GetTicks() */
    Sint32 which;       /**< The joystick device index for the ADDED event, _instance id for the REMOVED or REMAPPED event */
...
typedef struct SDL_SensorEvent
{
    ...
    Uint32 timestamp;   /**< In milliseconds, populated using SDL_GetTicks() */
    Sint32 which;       /**< The _instance ID of the sensor */
